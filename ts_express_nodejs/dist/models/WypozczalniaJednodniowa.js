...
exports.WypozczalniaJednodniowa = void 0;
class WypozczalniaJednodniowa {
    constructor(samochody) {
        this.podaj_wypozyczone = () => {
        ...
        this.podaj_top10_wypozyczanych = () => {
            var top10 = [];
            this.tab.forEach(function (s) {
                if (top10.length < 10) {
                    top10.push(s);
...
exports.WypozczalniaJednodniowa = WypozczalniaJednodniowa;
// ////*DATY*/
// var d1d = new Date();
// var d2d = new Date();
